...
user in an INI file next to SumatraPDFPortable.exe called SumatraPDFPortable.ini.
...
copy AppNamePortable.ini from this directory to SumatraPDFPortable.ini next to
SumatraPDFPortable.exe. The options in the INI file are as follows:
